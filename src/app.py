...
def calcular_puntos(center_x, center_y, center_z, radio, puntos):
...
with col1:
    center_x = st.number_input("Coordenada X del centro:", min_value=2.0, max_value=30.0, value=21.83, format="%.3f", step=0.5)
    center_y = st.number_input("Coordenada Y del centro:", min_value=2.0, max_value=30.0, value=12.66, format="%.3f", step=0.5)
    center_z = st.number_input("Altura:", min_value=2.0, max_value=30.0, value=5.625, format="%.3f", step=0.5)
with col2:
...
if st.button("✔ Generar puntos"):
    #cálculos
    st.session_state.df = calcular_puntos(center_x, center_y, center_z, radio, puntos)    
